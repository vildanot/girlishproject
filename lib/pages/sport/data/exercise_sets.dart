import 'package:loginpage/pages/sport/model/exercise_set.dart';
...
final exerciseSets = [
  ExerciseSet(
    ...
    imageUrl: 'assets/sport/workout1.png',
  ...
  ExerciseSet(
    ...
    imageUrl: 'assets/sport/crunch.png',
    exerciseType: ExerciseType.low,
  ...
  ExerciseSet(
    name: 'Upper Body',
    exercises: exercises1,
    imageUrl: 'assets/sport/pushup.png',
    exerciseType: ExerciseType.low,
  ...
  ExerciseSet(
    ...
    imageUrl: 'assets/sport/yoga.png',
    exerciseType: ExerciseType.low,
  ...
  ExerciseSet(
    name: 'Cardio',
    exercises: exercises3,
    imageUrl: 'assets/sport/workout3.png',
    exerciseType: ExerciseType.low,
  ...
  ExerciseSet(
    ...
    imageUrl: 'assets/sport/workout2.png',
